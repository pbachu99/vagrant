/* CREATE VIEW should be granted too. This can be later needed*/
/*
 * This script verifies and defines the PLSQL user. 
 * It should be run as the SYSTEM user or a user that has the DBA privilege role 
 */
...
BEGIN
  ...
  LOOP
    ...
    ELSE
      ...
      EXECUTE IMMEDIATE 'CREATE USER plsql IDENTIFIED BY plsql default tablespace plsqltbs quota unlimited on plsqltbs';
