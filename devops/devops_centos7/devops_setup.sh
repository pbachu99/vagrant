...
var_dir='cd /d/git/vagrant/devops/devops_centos7/jenkins/'
...
var_dir='cd /d/git/vagrant/devops/devops_centos7/containers/'
var_start='vagrant up'
$var_dir ; $var_start
;;
...
var_dir='cd /d/git/vagrant/devops/devops_centos7/tomcat/'
var_start='vagrant up'
$var_dir ; $var_start
;;
