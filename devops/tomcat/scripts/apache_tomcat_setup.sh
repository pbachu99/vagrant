# Apache_Tomcat Envirormnet setup 
sudo mkdir -p /u01/software/
sudo cp -f /vagrant/scripts/* /u01/software/
sudo cp -f /vagrant/software/* /u01/software/
sudo chown -R root:root /u01/
...
#echo "******************************************************************************"
sudo echo ". /u01/software/setEnv.sh" >> /root/.bash_profile
